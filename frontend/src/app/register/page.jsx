...
export default function RegisterPage() {
  ...
  return (
    <div className="relative h-[calc(100vh-64px)] w-screen overflow-hidden bg-cover bg-center bg-no-repeat flex items-center justify-center"
      ...
      <div className={`${outfit.className} backdrop-blur-xs bg-white/30 border border-white/40 rounded-2xl shadow-xl w-full max-w-4xl flex flex-col md:flex-row items-stretch overflow-hidde`}>
